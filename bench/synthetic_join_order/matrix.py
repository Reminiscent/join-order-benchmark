...
from .compile import VIRTUAL_ROWS_PER_PAGE, CompiledCase, compile_graph, write_case
from .graph import (
    BASE_ROWS_MAX,
    BASE_ROWS_MIN,
    MAX_AVERAGE_JOIN_GROWTH,
    GenerationSpec,
    generate_graph,
)
    ...
    *,
    ...
    context = {
        ...
        "cardinality_bounds": {
            ...
            "max_average_join_growth": MAX_AVERAGE_JOIN_GROWTH,
        },
        "virtual_rows_per_page": VIRTUAL_ROWS_PER_PAGE,
...
def _workload_diagnostic_row(
    ...
    return {
        **_spec_fields(spec),
        ...
        "variant": result.variant,
        "status": result.status,
        "raw_average_growth": balance["raw_average_growth"],
        "edge_scale": balance["edge_scale"],
