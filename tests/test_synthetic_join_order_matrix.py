...
class SyntheticJoinOrderMatrixTests(unittest.TestCase):
    ...
    def test_matrix_records_timeout_without_aborting(self) -> None:
        ...
        self.assertNotIn("edge_scale", diagnostic_fields)
        self.assertNotIn("root_effective_rows", diagnostic_fields)
        self.assertNotIn("selected_join_count", diagnostic_fields)
        self.assertIn("anchor_relation", diagnostic_fields)
        self.assertIn("cardinality_budget", diagnostic_fields)
        self.assertIn("root_growth_factor", diagnostic_fields)
        self.assertIn("contraction_log_budget", diagnostic_fields)
        self.assertIn("expansion_log_budget", diagnostic_fields)
        self.assertIn("minimum_connected_log_rows", diagnostic_fields)
        self.assertIn("maximum_connected_log_rows", diagnostic_fields)
        self.assertEqual(context["cardinality_bounds"]["cardinality_budget"], 100.0)
